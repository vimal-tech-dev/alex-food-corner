...
import img6 from "../assets/img/samosa/Samosa - 2.png";
import img7 from "../assets/img/samosa/Samosa - 3.png";
...
import img15 from "../assets/img/burger/Burger - 5.png";
import img16 from "../assets/img/burger/Burger - 6.png";
// Import French Fries
...
import img20 from "../assets/img/french fries/French Fries - 4.png";
    ...
    return (
        ...
        <div className=" min-h-screen flex flex-col justify-center items-center lg:px-32 px-5 bg-backgroundColor py-4">
            ...
            <div className=" flex flex-wrap gap-8 justify-center">
                ...
                <DishesCard img={img6} title="Samosa Dish" />
                <DishesCard img={img7} title="Samosa Pav Dish" />
                ...
                <DishesCard img={img15} title="Peri Peri Burger Dish" />
                <DishesCard img={img16} title="Veggie Cheese Burger Dish" />
                ...
                <DishesCard img={img20} title="Regular Fries Dish" />
